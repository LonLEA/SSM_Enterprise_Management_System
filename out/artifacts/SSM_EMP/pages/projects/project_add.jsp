...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/projects/addProject.do" method="post">
            <!-- 正文区域 -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input name="projectName" type="text" class="form-control" placeholder="项目">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <div class="input-group date">
                                ...
                                <input name="beginTime" type="text" class="form-control pull-right datepicker-a3" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <div class="input-group date">
                                ...
                                <input name="endTime" type="text" class="form-control pull-right datepicker-a3">
                            </div>
                        </div>

                        <div class="col-md-2 title">描述</div>
                        <div class="col-md-10 data">
                            <input name="description" rows="3" type="text" class="form-control" placeholder="姓名">
                        </div>
