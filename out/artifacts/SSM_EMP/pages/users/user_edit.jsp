    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/pages/users/user_list.jsp">用户管理</a></li>
        ...
        <section class="content">
            ...
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <input hidden name="id" value="${userInfo.id}">
                    ...
                    <div class="col-md-4 data">
                        <input name="age" type="text" class="form-control"
                               placeholder="${userInfo.age}" value="${userInfo.age}">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <select name="departmentId" class="form-control select2" style="width: 100%;">
                            <option value="${userInfo.department.id}">${userInfo.department.departmentName}</option>
                            <c:forEach var="department1" items="${sessionScope.departments}">
                            <option value="${department1.id}">${department1.departmentName}</option>
                            </c:forEach>
                        </select>
                    </div>
